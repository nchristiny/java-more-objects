...
public class Animate01 extends Frame implements Runnable {
	...
	Animate01() {//constructor
		...
		// image
		backGroundImage = Toolkit.getDefaultToolkit().getImage("background02.jpg");
...
class SpriteManager extends Vector {
	...
	private void bounceOffSprite(int oneHitIndex, int otherHitIndex){
		...
		Point swap = oneSprite.getMotionVector();oneSprite.setMotionVector(otherSprite.getMotionVector());
